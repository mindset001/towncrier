  ...
  return (
    <main className='bg-[#D0E2FE] w-full flex flex-col items-center justify-center py-10 border-t border-1'>
        <div className='w-[95%] lg:w-[75%] flex flex-col items-center justify-center text-center'>
            <h1 className='text-[28px] lg:text-[56px] font-[700] lg:leading-[67.2px]'>Discover the newsletter that will spark your imagination and fuel your purpose. </h1>
        ...
        <div className='w-[95%] md:w-[75%] flex flex-col items-center'>
            ...
            <p className='text-[12px] font-[400] px-2'>By clicking Sign Up you're confirming that you agree with our Terms and Conditions.</p>
        </div>
    </main>
  )
}
